    ...
    <div class="content-center text-center">
      <div class="col-md-8 mx-auto">
        <div class="brand">
          ...
          <h3 class="description">Documentation v3.0.4</h3>
          <br />
          <a href="https://www.creative-tim.com/learning-lab/bootstrap/overview/material-kit" class="btn btn-primary btn-lg">View documentation</a>
        </div>
      </div>
    </div>
  </div>
