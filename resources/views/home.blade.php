        ...
        <div class="col-md-3 mb-4 ms-auto">
          <div>
            <a href="https://www.creative-tim.com/product/material-kit">
              ...
              <img src="./assets/img/team-3.jpg"  width="" width="00pd" height="80pd  class="mb-3 footer-logo" alt="main_logo">

            </a>
            <h6  class="font-weight-bolder mb-4">Reza Aulia</h6>
          </div>
          <div>
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="text-dark my-4 text-sm font-weight-normal">
              ...
              </script> Rezha's <a href="https://www.creative-tim.com" target="_blank">Rezaauliarahmi</a>.
            </p>
          </div>
        </div>
      </div>
